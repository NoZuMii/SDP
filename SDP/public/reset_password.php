...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
   ...
   $sql = "SELECT * From user WHERE email='$Email' and phone ='$Telephone' and username = '$Username'";
   ...
   if (mysqli_num_rows($result) != 1) {
      ...
      $update_sql = "UPDATE user SET password='$password' WHERE email='$Email' and phone ='$Telephone' and username = '$Username'";
...
<body>
   <div class="form-container">
      ...
      <form action="" method="post">
         ...
         <section>
            <p><label for="passwordInput">New Password</label></p>
         </section>
         ...
         <section>
            <P><label for="confirmInput">Confirm Password</label></p>
         </section>
         ...
         <p style="clear:both;">Encounter an issue? <a style="color: lightblue;" href="../public/contact.php">Contact us!</a></p>
      </form>
   </div>
</body>
