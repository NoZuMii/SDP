<?php 
    ...
    if($role == 'student'){
        include '../includes/student_header.php'; // Get header
    } elseif($role == 'premium'){
    ...
    /* READ */
    $read_sql = "SELECT * FROM user WHERE userID='$userID'";
    ...
    if ($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            /* UPDATE */
            $update_sql = "UPDATE user SET username='$username', email='$email', phone='$phone' WHERE userID='$userID'";
