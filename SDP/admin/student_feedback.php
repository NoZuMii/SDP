...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    echo "success";
    echo "<script> alert('reply has been submitted!'); window.location.href='./student_feedback.php';</script>";
}
?>
...
<body>
    ...
    if (mysqli_num_rows($feedbackResult) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($feedbackResult)) {
            if ($row['role'] === 'teacher') {
                continue; // Skip this iteration if the role is teacher
            }
